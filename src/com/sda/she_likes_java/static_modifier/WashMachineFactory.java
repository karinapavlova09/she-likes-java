...
public class WashMachineFactory {
    public static void main(String[] args) {
        ...
        System.out.println("samsung seral number is: " + samsung.getSerialNumber());
        ...
        System.out.println("Current population number is: " + WashMachine.getNumberOfCreatedMachines());
        System.out.println("samsung2 seral number is: " + samsung2.getSerialNumber());

        for (int i = 0; i < 10; i++) {
            makeSomeWashMachines();
        }
        // some generic way to obtain number of produced washmachines
        System.out.println("Hey, we've made lots of washing machine: " + WashMachine.getNumberOfCreatedMachines());
    }
